...
public class AlchemancyItems
{
	...
	public static final DeferredItem<InnatePropertyItem> IRON_RING = REGISTRY.register("iron_ring", () -> new InnatePropertyItem.Builder().auxiliary(false).stacksTo(1).infusionSlots(1).build());
