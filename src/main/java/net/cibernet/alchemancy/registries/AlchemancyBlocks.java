...
public class AlchemancyBlocks
{
	...
	public static final DeferredBlock<GustBasketBlock> GUST_BASKET = REGISTRY.register("gust_basket", () -> new GustBasketBlock(BlockBehaviour.Properties.of().randomTicks().sound(SoundType.SCULK).mapColor(MapColor.COLOR_BLACK).strength(1.5F).sound(SoundType.SCULK)));
