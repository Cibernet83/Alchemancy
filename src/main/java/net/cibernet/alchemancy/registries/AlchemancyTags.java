...
public class AlchemancyTags
{
	public static class Items
	{
        ...
        public static final TagKey<Item> IGNORED_BY_INFUSION_FLASK = registerTag(Registries.ITEM, "ignored_by_infusion_flask");
		...
		public static final TagKey<Item> CANNOT_TINT = registerTag(Registries.ITEM, "cannot_tint");
	...
	public static class DataComponents
	{
		...
		public static final TagKey<DataComponentType<?>> FRAGMENTED_DOES_NOT_CLONE = registerTag(Registries.DATA_COMPONENT_TYPE, "fragmented_does_not_clone");
	}
