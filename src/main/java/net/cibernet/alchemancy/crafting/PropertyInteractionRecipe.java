...
public class PropertyInteractionRecipe extends AbstractForgeRecipe<List<Holder<Property>>>
{
	...
	public boolean matches(ForgeRecipeGrid input, Level level) {
		return !InfusedPropertiesHelper.hasProperty(input.getCurrentOutput(), AlchemancyProperties.PARADOXICAL) && super.matches(input, level);
	}
	...
	public RecipeSerializer<?> getSerializer() {
		return AlchemancyRecipeTypes.Serializers.PROPERTY_INTERACTION.get();
	}
}
